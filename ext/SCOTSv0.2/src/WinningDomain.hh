...
// friend bool write_to_file(const UniformGrid& input, const UniformGrid& state, const WinningDomain& wd, const std::string& filename, bool raw = true);
...
public:
  ...
  /** @brief get the valid input N*M **/
  std::vector<bool> get_valid_inputs() const {
    return m_inputs;
  }
