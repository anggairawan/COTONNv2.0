...
int main() {
  ...
  std::string path="simulation_sequences/sequence_complete.txt";
  std::string path_int="simulation_sequences/sequence_int.txt";

  std::ofstream myfile(path);
  std::ofstream myfile_int(path_int);

  // myfile.open ("simulation_sequences/sequence_complete.txt");
  // myfile_int.open ("simulation_sequences/sequence_int.txt");
